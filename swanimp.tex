...
\chap{Compling and running unstructured mesh SWAN in parallel} \label{ch:punswan}
...
2. prepall
\end{verbatim}
Be sure that you must specify the name of the UnSWAN file as {\tt INPUT}. So, you must copy your command file to {\tt INPUT} first before running {\tt adcprep}
(assuming {\tt INPUT} is the standard file name for command input, see Chapter \ref{ch:usechan}).
\\[2ex]
\noindent
